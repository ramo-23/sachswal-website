...
export const GALLERY_ITEMS: ImageItem[] = [
  { id: 'nissa-team', src: '/images/nissa_team.jpeg', title: 'NISSA Project Team', shortDescription: 'NISSA project team meeting', location: 'Maseru', year: 2025, category: 'Projects', featured: true },
  { id: 'nissa-update', src: '/images/nissa_updating.jpeg', title: 'NISSA Updating Fieldwork', shortDescription: 'Field data collection for NISSA update', location: 'Various', year: 2025, category: 'Projects' },
  ...
  { id: 'training-session', src: '/images/training_session.jpg', title: 'Training Workshop', shortDescription: 'Teacher training workshop', location: 'Mafeteng', year: 2023, category: 'Training & Workshops' },
  { id: 'workshop', src: '/images/workshop.jpg', title: 'Reading Circle', shortDescription: 'Reading circle at local school', location: 'Mafeteng', year: 2023, category: 'School Programmes' },
