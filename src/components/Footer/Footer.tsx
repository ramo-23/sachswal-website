        ...
        <div className="max-w-350 mx-auto px-8">
          <div className="flex flex-col md:flex-row justify-between items-start gap-6">
            ...
            <div className="min-w-0">
              ...
              <div className="mt-1 text-sm text-gray-700">Strengthening families and communities so children thrive.</div>
            </div>

            {/* Center: Contact info with header */}
            <div className="text-sm text-gray-600">
              <div className="mb-2 text-sm font-semibold text-gray-900">Contact</div>
              <div className="text-gray-700">Phone: <a href="tel:+26662031938" className="text-gray-800">+266 6203 1938</a></div>
              <div className="mt-1">
                Email: <a href="mailto:sachswal@gmail.com" className="underline text-gray-700 hover:text-gray-900">sachswal@gmail.com</a>
              </div>
              <div className="mt-1 text-gray-700">Address: Zille Building, Thabana Morena Rd, Mafeteng, Lesotho</div>
              <div className="mt-1 text-gray-700">Office hours: Mon–Fri 08:00–17:00, Sat 09:00–13:00</div>
            </div>

            {/* Right: Social icons with header */}
            <div className="flex md:justify-end md:items-start">
              <div>
                <div className="mb-2 text-sm font-semibold text-gray-900">Find us</div>
                <div className="flex gap-3">
                  <a
                    ...
                    className="inline-flex items-center justify-center w-10 h-10 bg-white rounded-full text-gray-600 hover:text-gray-900 transition-transform duration-150 transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-200 shadow-md"
                  >
